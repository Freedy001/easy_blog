...
- 创建其他用户与你一起当这个博客系统的主人，发文章前台都可以看见（会标明作者信息）。
...
7. 发布文章时选择发布时间如果晚于当前时间，会在你指定的时间去上架文章。在文章上架前，前端页面是完全无法感知的，包括首页与搜索页面。
...
由于本地的markdown越来越多不方便查找，再加上最近正想找下练手项目，于是这个博客系统就但是啦😏

由于本人的技术能力有限可能会有一些bug,如果发现可以给我提，我会收集起来有时间集中修改。
