...
public class RabbitConstant {
    ...
    public static final String ARTICLE_PARAMETER_QUEUE_NAME="article.parameter.queue";
    public static final String ARTICLE_PARAMETER_ROUTING_KEY="article.parameter.routing.key";
}
