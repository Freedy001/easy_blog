...
public class OperationLog{
    ...
    private static OperationLogService logService = null;

    private static StringRedisTemplate redisTemplate;

    private final ApplicationContext applicationContext;

    public OperationLog(OperationLogService logService,ApplicationContext applicationContext, StringRedisTemplate redisTemplate) {
        this.applicationContext = applicationContext;
        OperationLog.redisTemplate = redisTemplate;
        OperationLog.logService = logService;
    }
